...
问题:
① x64下，GetExitCodeThread无法返回 8个字节的基址
...
#ifdef _WIN64
TCHAR szDlgTitle[0x10] = TEXT("InJectDll(x64)");
#else
TCHAR szDlgTitle[0x10] = TEXT("InJectDll(x86)");
#endif
...
{
    hInst = hInstance;
    DialogBox(hInstance,MAKEINTRESOURCE(IDD_MAIN),NULL, DialogMainProc);
