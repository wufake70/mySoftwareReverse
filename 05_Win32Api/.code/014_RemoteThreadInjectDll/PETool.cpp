...
)
{
    ...
    case WM_COMMAND:
        ...
        // 程序加壳
        case IDC_PE_PACKING:
            DialogBox(hAppInstance, MAKEINTRESOURCE(IDD_DLG_PACKING), handDlg, DialogPackingProc);
            return TRUE;

        // 远程注入
        case IDC_REMOTE_INJECT_DLL:
            DialogBox(hAppInstance, MAKEINTRESOURCE(IDD_DLG_REMOTE_INJECT), handDlg, DialogRemoteInJectProc);
            return TRUE;
        }
